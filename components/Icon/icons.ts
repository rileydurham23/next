...
export { ReactComponent as puzzle } from "./svg/puzzle.svg";
export { ReactComponent as hearth } from "./svg/hearth.svg";
export { ReactComponent as wellPaid } from "./svg/well-paid.svg";
export { ReactComponent as balance } from "./svg/balance.svg";
export { ReactComponent as honesty } from "./svg/honesty.svg";
export { ReactComponent as humility } from "./svg/humility.svg";
export { ReactComponent as thoughtulness } from "./svg/thoughtulness.svg";
export { ReactComponent as transparency } from "./svg/transparency.svg";
export { ReactComponent as equity } from "./svg/equity.svg";
export { ReactComponent as healthCoverage } from "./svg/health_coverage.svg";
export { ReactComponent as otherBenefits } from "./svg/other_benefits.svg";
export { ReactComponent as profDevelopment } from "./svg/prof_development.svg";
export { ReactComponent as saveForTheFuture } from "./svg/save_for_the_future.svg";
export { ReactComponent as sickLeaveVocation } from "./svg/sick_leave_vocation.svg";
