  ...
  return (
    <MDX>
      <SectionTabs subtitle="Core Features">
        ...
        >
          <Image src={greenImg} width={400} height={400} layout="intrinsic" />
        </SectionTabs.Item>
        <SectionTabs.Item
          src={redImg}
        ...
        >
          <Image src={redImg} width={400} height={400} layout="intrinsic" />
        </SectionTabs.Item>
        <SectionTabs.Item
          src={blueImg}
        ...
        >
          <Image src={blueImg} width={400} height={400} layout="intrinsic" />
        </SectionTabs.Item>
      </SectionTabs>
    </MDX>
  );
