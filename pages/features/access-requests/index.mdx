...
<Section bg="gray">
  ...
  <Box boxShadow="0 4px 32px rgba(0, 0, 0, 0.24)" borderRadius="md" lineHeight="0">
    <NextImage
      src="./assets/animation-access-request.png"
      width={530}
      height={530}
      layout="intrinsic"
    />
...
<Section bg="squares">
<SectionSteps title="Access Requests Flow" description={<>To learn more about access requests, take a look at <Link href="/docs/" scheme="site">Teleport Documentation</Link> or read our <Link href="https://goteleport.com/features/access-requests/" scheme="site">blog</Link>.</>}>
  <SectionSteps.Item
    title="STEP 1"
