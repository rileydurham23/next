...
import FeatureTileWrapper from "components/Tile/FeatureTileWrapper";
  ...
  <Flex flexDirection="column" alignItems="flex-end" px={[4, 5, 11]} pt={6}>
    <Box fontSize="text-xl">
      ...
      <Box>
        ...
        Kubernetes clusters, web apps, PostgreSQL and MySQL databases behind
        NAT. Teleport is trivial to setup as a Linux daemon or in a Kubernetes
        pod.{" "}
        <Link
          color="light-blue"
