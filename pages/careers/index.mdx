...
<List subtitle="We value" grid>
  <ListItem src="./assets/balance.svg">
    ### Balance
  ...
  <ListItem src="./assets/humility.svg">
    ### Humility
  ...
  <ListItem src="./assets/honesty.svg">
    ### Honesty
  ...
  <ListItem src="./assets/transparency.svg">
    ### Transparency
  ...
  <ListItem src="./assets/thoughtulness.svg">
    ### Thoughtfulness
...
<List subtitle="Benefits & Perks" grid>
  <ListItem src="./assets/health-coverage.svg">
    ### Health Coverage
  ...
  <ListItem src="./assets/sick-leave-vocation.svg">
  ...
  <ListItem src="./assets/prof-development.svg">
  ...
  <ListItem src="./assets/equity.svg">
    ### Equity
  ...
  <ListItem src="./assets/save-for-the-future.svg">
    ### Save for the Future
  ...
  <ListItem src="./assets/other-benefits.svg">
