...
<List subtitle="We value" grid pt={[5, 10]}>
  <List.Item src="./assets/balance.svg">
    ### Balance
  ...
  <List.Item src="./assets/humility.svg">
    ### Humility
  ...
  <List.Item src="./assets/honesty.svg">
    ### Honesty
  ...
  <List.Item src="./assets/transparency.svg">
    ### Transparency
  ...
  <List.Item src="./assets/thoughtulness.svg">
    ### Thoughtfulness
...
<List subtitle="Benefits & Perks" grid pt={[5, 10]}>
  <List.Item src="./assets/health-coverage.svg">
    ### Health Coverage
  ...
  <List.Item src="./assets/sick-leave-vocation.svg">
  ...
  <List.Item src="./assets/prof-development.svg">
  ...
  <List.Item src="./assets/equity.svg">
    ### Equity
  ...
  <List.Item src="./assets/save-for-the-future.svg">
    ### Save for the Future
  ...
  <List.Item src="./assets/other-benefits.svg">
