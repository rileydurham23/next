...
border: none
hideWave: true
description: "How to build Teleport Community Edition from source. The easiest, most secure way to access all your infrastructure."
---
...
>
  <Box>
    ...
    <ul>
      <li>
          <Link
            href="https://goteleport.com/docs/installation/"
            color="light-purple"
          >
            Teleport Pre-built Binaries
          </Link>
        </li>
          <li>
          <Link
            href="https://charts.releases.teleport.dev/"
            color="light-purple"
          >
