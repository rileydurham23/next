...
<Section width="100%" bg="flatWhite">
  <ProductBanner
    ...
    description={
      <>
Running mission critical applications on AWS requires controlling who can provision and access resources like AWS Console, EC2, RDS, Aurora, and EKS. Not every AWS user in your organization needs access to everything. AWS Console might be used by DevOps engineers responsible for maintaining your infrastructure. EC2 instances might by accessed by on-call SREs.  RDS and Aurora by DBAs or data analysts.  Managing identity-based access to such a wide variety of roles is time-consuming and complex but necessary to control costs & ensure security & compliance.
      </>
    }
>
