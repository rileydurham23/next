...
articleTitle: Kubernetes Production Patterns and Anti-Patterns
date: "2017-06-25"
...
In this post, we explore helpful techniques to improve resiliency and high availability
of Kubernetes deployments and take a look at some common mistakes to avoid when
working with Docker and Kubernetes.

## Installation

First, follow the [installation instructions on Github](https://github.com/gravitational/workshop/blob/master/README.md#installation).
...
**UPDATE:** [Multi-stage builds is now available in CE](https://docs.docker.com/develop/develop-images/multistage-build/).
...
[Kubernetes Pod](https://kubernetes.io/docs/concepts/workloads/pods/#what-is-a-pod/) is a building block that itself is not durable.
...
Every time you write something to container's filesystem, it activates [copy on write strategy](https://docs.docker.com/storage/storagedriver/).
...
Kubernetes provides new useful tool to schedule containers to perform one-time task: [jobs](https://kubernetes.io/docs/concepts/workloads/controllers/job/)
...
<BlogImage src="./assets/CircuitStandby.png" />
...
<BlogImage src="./assets/CircuitTripped.png" />
...
**NOTE:** There are some production level proxies that natively support circuit breaker pattern - such as [Vulcand](http://vulcand.github.io/), [Nginx plus](https://www.nginx.com/products/) or [Envoy](https://www.envoyproxy.io/).
...
[Istio](https://istio.io/latest/docs/concepts/) is an example of platform that embodies this design and more for instance.
