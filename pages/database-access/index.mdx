...
<Section bg="wavelight">
  ...
  >
    ...
    <ProductBanner.Item title="Access Requests" >
      Move away from admin accounts with just-in-time privilege escalation for administrative tasks. Access requests can be approved via Slack or other supported plug-ins.
    </ProductBanner.Item>
