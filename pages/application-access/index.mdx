...
<Section bg="flatWhite">
  ...
  >
    <ProductBanner.Item title="Single Sign On with MFA " >
      Teleport brings security best practices and compliance controls to all internal web apps, including SSO, MFA with auto-expiring certificates tied to a user identity.
    </ProductBanner.Item>
