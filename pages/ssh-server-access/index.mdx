...
<Section bg="waveLight">
  ...
  >
    ...
    <ProductBanner.Item title="Access Requests">
      Move away from root accounts with just-in-time SSH privilege escalation for administrative tasks. Access requests can be approved via Slack or other supported plug-ins.
    </ProductBanner.Item>
  </ProductBanner>
</Section>
