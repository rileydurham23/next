...
<WorksWith title="Works with everything you have">
  ...
  single binary, it seamlessly integrates with the rest of your stack and is fully
  compatible with OpenSSH and other [SSH-based tooling](https://goteleport.com/ssh/).
</WorksWith>
<EasyStart
