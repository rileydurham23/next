...
| TEAM                    | PROBLEM                          |
|-------------------------|----------------------------------|
|           Infrastructure| Onboarding/offboarding employees |
|                         | Hard-coded and shared secrets    |
|           Security      | Hard-coded and shared secrets    |

<Box float="right" ml={4}>
  <Figure
    yMargin={0}
    width={333}
    height={400}
  ...
  >
    ![ExtraHop Cluster Architecture](./assets/extrahop-cluster-architecture.png)
  </Figure>
</Box>
...
>
    ![Teleport Proxy with SSH Reverse Tunnel](./assets/teleport-proxy-with-ssh-reverse-tunnel.png)
</Figure>
...
<Figure
  ...
  imagePositioning="center"
>
    ![Teleport auth service collecting data SAML assertions](./assets/teleport-auth-service-collecting-data-saml.png)
</Figure>
