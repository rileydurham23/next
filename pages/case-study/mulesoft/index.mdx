...
reviews:
  - mulesoft
$images:
  logo: ./assets/mulesoft@2x.svg
logoAlt: logo MuleSoft
...
- <b>Secure and highly available.</b> MuleSoft customers can easily install secure and highly available instances of Anypoint Platform on their private infrastructure.
- <b>Migration to Kubernetes.</b> Teleport helped MuleSoft migrate Anypoint Platform to Kubernetes and trained MuleSoft developers in Kubernetes best practices.
- <b>Integrated CI/CD workflow.</b> MuleSoft developers were able to maintain much of their existing software development tooling and processes.
