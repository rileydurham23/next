...
companyLogo:
  ...
  height: 52
  alt: logo ECMWF
articleTitle: How Third Parties Securely Access Supercomputing Clusters
---
...
<CaseStudy subtitle="Customer Case Study" title={meta.articleTitle} companyLogo={meta.companyLogo} poster="./assets/ecmwf.png">
  ...
  >
    ![Positive feedback](./assets/ecmwf-comments.png)
  </Figure>
</CaseStudy>
