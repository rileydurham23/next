...
>
  ...
  >
   ...
   <List.AvatarItem
    ...
    date="Mar 15, 10am PT"
    brief="Our collective cybersecurity posture is dramatically different from 18 months ago. New and clever data breaches pepper the news and the security industry megaphone touts..."
    style={{ marginRight: [0, "65px"]}}
  >
