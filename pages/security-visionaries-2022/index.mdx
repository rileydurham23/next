...
<List
  ...
  description={
    <SignupDescription description={meta.headerDescription} fontSize="text-xl">
        <MarketoBrowserForm id="1192" p={4} mt={["auto", "auto", "125px"]} mr={["auto", "auto", "-40px"]} bg="white" borderRadius="md" boxShadow="0 0 64px rgba(0, 0, 0, 0.32)" css={css({fieldset: {div: {label: {ml: 3}}}})}/>
    </SignupDescription>
  }
>
  <List.AvatarItem
